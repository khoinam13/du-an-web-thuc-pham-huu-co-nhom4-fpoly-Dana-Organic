             ...
             <div  style={{width:'76%', margin:'0 auto',marginBottom:'20px',marginTop:'20px'}}>
                            ...
                            <div >
                                ...
                                <div style={{border:'1px solid #ebebeb', padding:'20px',display:'flex',justifyContent:'center',alignItems:'center',gap:'60px',flexWrap:'wrap'}}>
                                   <div style={{width:'70%',display:'flex',justifyContent:'center',alignItems:'center',border:'1px solid #ebebeb', padding:'20px',flexWrap:'wrap',gap:'30px'}}>
                                            
                                        <div >
                                        <h2> Đánh giá </h2>
                                        <div style={{ display:'flex',gap:'20px',justifyContent:"center",alignItems:'center'}}>
                                            <span>
                                            <h2 style={{ color:'#777777'}}>5<i class="fa-solid fa-star" style={{color: '#dedede'}}></i></h2>
                                            </span>
                                            <span style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
                                                <div style={{ backgroundColor:'#eee',border:"1px solid #eee",width:'400px',height:'20px',borderRadius:'3px'}}></div>
                                            </span>
                                        ...
                                        <div style={{ display:'flex',gap:'20px',justifyContent:"center",alignItems:'center'}}>
                                            <span>
                                            <h2 style={{ color:'#777777'}}>4<i class="fa-solid fa-star" style={{color: '#dedede'}}></i></h2>
                                            </span>
                                            <span style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
                                                <div style={{ backgroundColor:'#eee',border:"1px solid #eee",width:'400px',height:'20px',borderRadius:'3px'}}></div>
                                            </span>
                                        ...
                                        <div style={{ display:'flex',gap:'20px',justifyContent:"center",alignItems:'center'}}>
                                            <span>
                                            <h2 style={{ color:'#777777'}}>3<i class="fa-solid fa-star" style={{color: '#dedede'}}></i></h2>
                                            </span>
                                            <span style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
                                                <div style={{ backgroundColor:'#eee',border:"1px solid #eee",width:'400px',height:'20px',borderRadius:'3px'}}></div>
                                            </span>
                                        ...
                                        <div style={{ display:'flex',gap:'20px',justifyContent:"center",alignItems:'center'}}>
                                            <span>
                                            <h2 style={{ color:'#777777'}}>2<i class="fa-solid fa-star" style={{color: '#dedede'}}></i></h2>
                                            </span>
                                            <span style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
                                                <div style={{ backgroundColor:'#eee',border:"1px solid #eee",width:'400px',height:'20px',borderRadius:'3px'}}></div>
                                            </span>
                                        ...
                                        <div style={{ display:'flex',gap:'20px',justifyContent:"center",alignItems:'center'}}>
                                            <span>
                                            <h2 style={{ color:'#777777'}}>1<i class="fa-solid fa-star" style={{color: '#dedede'}}></i></h2>
                                            </span>
                                            <span style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
                                                <div style={{ backgroundColor:'#eee',border:"1px solid #eee",width:'400px',height:'20px',borderRadius:'3px'}}></div>
                                            </span>
                                    ...
                                    <div>
                                            ...
                                            <div class="modal-dialog" >
                                                ...
                                                <div class="modal-body">
                                                    <textarea placeholder="Mời bạn chia sẽ cảm nhận về sản phẩm..." style={{width:'100%',height:'140px',borderRadius:'5px'}}>

                                                    </textarea>
                                                    <div  style={{marginBottom:'20px',marginTop:'20px'}}>
                                                        <h3 style={{ color:'#77777',fontSize:'25px'}}>Ảnh Thực Tế Sản Phẩm</h3>
                                                        <input type={'file'} />
                                                    </div>
                                                    <div>
                                                        <h3 style={{ color:'#77777',fontSize:'25px'}}>Bạn cảm thấy sản phẩm như thế nào:</h3>
                                                        <div style={{display:'flex',gap:'20px',justifyContent:'center',alignItems:'center'}}>
                                                        <span style={{fontSize:'25px',color:"#999"}}>
                                                                <span> <i class="fa-solid fa-star" style={{color: '#dedede'}}></i></span>
                                                                <span> Rất Tệ</span>
                                   ...
                                   <div style={{width:'70%',display:'flex',justifyContent:'center',alignItems:'center',border:'1px solid #ebebeb', padding:'20px',flexWrap:'wrap'}}>
